...
function Navigation({onOpenSidePanel, isSidePanelOpen, loggedIn, width}) {
    ...
    const loggedNavLinks = 
        <ul className='navigation__ul navigation__ul_type_logged-in'>
            { width <= 768 && <li className='navigation__li navigation__li_type_logged-in'> 
                <NavLink to='/' className={({isActive}) => `navigation__link ${isActive ? "navigation__link_active" : ""}`}>Главная</NavLink> 
            </li> }
            <li className='navigation__li navigation__li_type_logged-in'> 
            ...
            <li className='navigation__li navigation__li_type_logged-in'> 
                <div className='navigation__profile-wrapper'> 
                    ...
                    <NavLink to='/profile' className="navigation__link navigation__link_type_img"/>
                </div> 
            </li>
        </ul>;
