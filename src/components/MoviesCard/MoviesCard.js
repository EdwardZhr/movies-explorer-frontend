    ...
    return (
      <div className= 'movies-card' onMouseEnter={onMouseEnterHandler} onMouseLeave={onMouseLeaveHandler}>
        ...
        <div className='movies-card__info'>
          ...
          <button className={((savedMovie && showBtn && `movies-card__save movies-card__save_type_delete`) || (savedMovie && `movies-card__save movies-card__save_hidden`)) || (isSaved && `movies-card__save movies-card__save_active`) || `movies-card__save`} onClick={save}></button>
